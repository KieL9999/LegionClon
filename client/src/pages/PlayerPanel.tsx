                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <Card className="bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-blue-500/30">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm font-semibold text-blue-300 drop-shadow-[0_0_6px_rgba(147,197,253,0.8)]">Última Conexión</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-purple-500/20 to-purple-500/5 border-purple-500/30">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm font-semibold text-purple-300 drop-shadow-[0_0_6px_rgba(196,181,253,0.8)]">Miembro desde</p>
                    </CardContent>
                  </Card>
                </div>
